...
SRCS = main.f timed_hydro_shock.f trsub.f rad.f coll_rec.f radsub.f \
	...
	rates_2.f big.f cross.f cfit.f cont_emiss2.f chianti_data.f chianti_data_2022_v4.f rechyfit.f verner_fit.f diff_em_sub.f coll_ionization_verner.f auger.f read_auger.f num_shell.f read_rr_diel_badnell_v2.f dielbadnell.f 
OBJS = $(SRCS:.f=.o)
