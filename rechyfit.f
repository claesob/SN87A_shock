      subroutine rechyd(iz,nmax,te)
                                                                        
c	/* From Cloudy                                                         
c	 * Version 4, October 9, 1997                                          
c	 **********************************************************************
c	 *** This subroutine calculates state-specific recombination rates     
c	 *** for hydrogen and hydrogen-like ions.                              
c	 *** Input parameters:  iz - atomic number                             
c	 ***          n  - shell number, from 0 to 400:                        
c	 ***                                    0 - 1s                         
c	 ***                                    1 - 2s                         
c	 ***                                    2 - 2p                         
c	 ***                                    3 - 3                          
...
c	 **********************************************************************
     ...
     & 3.9442052e-04,-7.0510376e-03/                  
      ...
      data (recfit(99,j),j=1,9) /-1.2720232e01,-1.8927985e-01,2.8911681e00,                
     ...
     & 3.9204193e-04,-7.0383926e-03/                  
      ...
      data (recfit(100,j),j=1,9) /-1.2725187e01,-1.8697031e-01,       
     ...
     & 1.0632223e-01,3.9013205e-04,-7.0150336e-03/    
      ...
      data (recfit(101,j),j=1,9) /-1.2730112e01,-1.8481848e-01,       
     ...
     & 1.0584479e-01,3.8825095e-04,-6.9906744e-03/    
      ...
      data (recfit(102,j),j=1,9) /-1.2735051e01,-1.8243988e-01,       
     ...
     & 1.0532672e-01,3.8610981e-04,-6.9607552e-03/    
      ...
      data (recfit(103,j),j=1,9) /-1.2739732e01,-1.8050966e-01,       
     ...
     & 1.0488666e-01,3.8469775e-04,-6.9447402e-03/    
      ...
      data (recfit(104,j),j=1,9) /-1.2744627e01,-1.7821079e-01,       
     ...
     & 1.0425440e-01,3.8241854e-04,-6.9190636e-03/    
      ...
      data (recfit(105,j),j=1,9) /-1.2749469e01,-1.7617977e-01,       
     ...
     & 1.0350873e-01,3.8018939e-04,-6.9033392e-03/    
      ...
      data (recfit(106,j),j=1,9) /-1.2754121e01,-1.7402913e-01,       
     ...
     & 1.0314499e-01,3.7855521e-04,-6.8763983e-03/    
      ...
      data (recfit(107,j),j=1,9) /-1.2758902e01,-1.7190276e-01,       
     ...
     & 1.0242753e-01,3.7621209e-04,-6.8553095e-03/    
      ...
      data (recfit(108,j),j=1,9) /-1.2763551e01,-1.7006454e-01,       
     ...
     & 1.0177421e-01,3.7423181e-04,-6.8404377e-03/    
      ...
      data (recfit(109,j),j=1,9) /-1.2768171e01,-1.6788185e-01,       
     ...
     & 1.0120909e-01,3.7229306e-04,-6.8178363e-03/    
      ...
      data (recfit(110,j),j=1,9) /-1.2772773e01,-1.6604213e-01,       
     ...
     & 1.0044731e-01,3.7019985e-04,-6.8062712e-03/    
      ...
      data (recfit(111,j),j=1,9) /-1.2777718e01,-1.6405818e-01,       
     ...
     &  9.9106148e-02,3.6661720e-04,-6.7962422e-03/    
      ...
      data (recfit(112,j),j=1,9) /-1.2782169e01,-1.6187979e-01,       
     ...
     &  9.8753296e-02,3.6503130e-04,-6.7688031e-03/    
      ...
      data (recfit(113,j),j=1,9) /-1.2786533e01,-1.6020589e-01,       
     ...
     &  9.8308109e-02,3.6362084e-04,-6.7547909e-03/    
      ...
      data (recfit(114,j),j=1,9) /-1.2791161e01,-1.5836388e-01,       
     ...
     &  9.7141266e-02,3.6066718e-04,-6.7469878e-03/    
      ...
      data (recfit(115,j),j=1,9) /-1.2795451e01,-1.5683571e-01,       
     ...
     &  9.6520007e-02,3.5906475e-04,-6.7389519e-03/    
      ...
      data (recfit(116,j),j=1,9) /-1.2799765e01,-1.5458080e-01,       
     ...
     &  9.6341960e-02,3.5761393e-04,-6.7037246e-03/    
      ...
      data (recfit(117,j),j=1,9) /-1.2804143e01,-1.5230910e-01,       
     ...
     &  9.5899299e-02,3.5559351e-04,-6.6707791e-03/    
      ...
      data (recfit(118,j),j=1,9) /-1.2808454e01,-1.5097314e-01,       
     ...
     &  9.4947547e-02,3.5351014e-04,-6.6728336e-03/    
      ...
      data (recfit(119,j),j=1,9) /-1.2813090e01,-1.4845622e-01,       
     ...
     &  9.3970671e-02,3.5044577e-04,-6.6471626e-03/    
      ...
      data (recfit(120,j),j=1,9) /-1.2817281e01,-1.4774430e-01,       
     ...
     &  9.2604160e-02,3.4769412e-04,-6.6605825e-03/    
      ...
      data (recfit(121,j),j=1,9) /-1.2821519e01,-1.4589632e-01,       
     ...
     &  9.2037052e-02,3.4597234e-04,-6.6446606e-03/    
      ...
      data (recfit(122,j),j=1,9) /-1.2825975e01,-1.4377499e-01,       
     ...
     &  9.0978615e-02,3.4286492e-04,-6.6240961e-03/    
      ...
      data (recfit(123,j),j=1,9) /-1.2830273e01,-1.4179285e-01,       
     ...
     &  9.0205699e-02,3.4043915e-04,-6.6031534e-03/    
      ...
      data (recfit(124,j),j=1,9) /-1.2834367e01,-1.3986248e-01,       
     ...
     & 8.9603320e-02,3.3851157e-04,-6.5819244e-03/    
      ...
      data (recfit(125,j),j=1,9) /-1.2838687e01,-1.3878451e-01,       
     ...
     & 8.8276260e-02,3.3580596e-04,-6.5941932e-03/    
      ...
      data (recfit(126,j),j=1,9) /-1.2842663e01,-1.3698161e-01,       
     ...
     & 8.7770551e-02,3.3414972e-04,-6.5738978e-03/    
      ...
      data (recfit(127,j),j=1,9) /-1.2846719e01,-1.3490482e-01,       
     ...
     & 8.7293297e-02,3.3212930e-04,-6.5425951e-03/    
      ...
      data (recfit(128,j),j=1,9) /-1.2851072e01,-1.3286085e-01,       
     ...
     & 8.6174607e-02,3.2900393e-04,-6.5256553e-03/    
      ...
      data (recfit(129,j),j=1,9) /-1.2855010e01,-1.3115966e-01,       
     ...
     & 8.5600451e-02,3.2729845e-04,-6.5091895e-03/    
      ...
      data (recfit(130,j),j=1,9) /-1.2859076e01,-1.2951696e-01,       
     ...
     & 8.4609129e-02,3.2487098e-04,-6.5011480e-03/    
      ...
      data (recfit(131,j),j=1,9) /-1.2862962e01,-1.2806115e-01,       
     ...
     & 8.3987780e-02,3.2303145e-04,-6.4860713e-03/    
      ...
      data (recfit(132,j),j=1,9) /-1.2866885e01,-1.2593497e-01,       
     ...
     & 8.3711669e-02,3.2156793e-04,-6.4560063e-03/    
      ...
      data (recfit(133,j),j=1,9) /-1.2870798e01,-1.2430360e-01,       
     ...
     & 8.3061904e-02,3.1944070e-04,-6.4350981e-03/    
      ...
      data (recfit(134,j),j=1,9) /-1.2874683e01,-1.2223892e-01,       
     ...
     & 8.2696706e-02,3.1798150e-04,-6.4104544e-03/    
      ...
      data (recfit(135,j),j=1,9) /-1.2878332e01,-1.2095545e-01,       
     ...
     & 8.2289040e-02,3.1698853e-04,-6.4024334e-03/    
      ...
      data (recfit(136,j),j=1,9) /-1.2882322e01,-1.1863913e-01,       
     ...
     & 8.1718683e-02,3.1460490e-04,-6.3670999e-03/    
      ...
      data (recfit(137,j),j=1,9) /-1.2886093e01,-1.1708276e-01,       
     ...
     & 8.1275731e-02,3.1307340e-04,-6.3485675e-03/    
      ...
      data (recfit(138,j),j=1,9) /-1.2889717e01,-1.1604929e-01,       
     ...
     & 8.0520988e-02,3.1154527e-04,-6.3489736e-03/    
      ...
      data (recfit(139,j),j=1,9) /-1.2893471e01,-1.1439819e-01,       
     ...
     & 8.0017231e-02,3.0997751e-04,-6.3321008e-03/    
      ...
      data (recfit(140,j),j=1,9) /-1.2897036e01,-1.1299469e-01,       
     ...
     & 7.9664923e-02,3.0880058e-04,-6.3155042e-03/    
      ...
      data (recfit(141,j),j=1,9) /-1.2900756e01,-1.1104361e-01,       
     & 1.9007665e00,5.0011914e-02,-8.5222423e-01,-3.9856685e-03,           
     & 7.9341255e-02,3.0698982e-04,-6.2807263e-03/    
		       
		       
			      
      data (recfit(142,j),j=1,9) /-1.2904379e01,-1.0948732e-01,       
     ...
     & 7.8983717e-02,3.0581685e-04,-6.2647904e-03/    
      ...
      data (recfit(143,j),j=1,9) /-1.2907994e01,-1.0778527e-01,       
     ...
     & 7.8647867e-02,3.0453241e-04,-6.2438506e-03/    
      ...
      data (recfit(144,j),j=1,9) /-1.2911791e01,-1.0570679e-01,       
     ...
     & 7.8097925e-02,3.0244072e-04,-6.2155398e-03/    
      ...
      data (recfit(145,j),j=1,9) /-1.2915656e01,-1.0367294e-01,       
     ...
     & 7.7148400e-02,2.9961241e-04,-6.1926078e-03/    
      ...
      data (recfit(146,j),j=1,9) /-1.2918971e01,-1.0285259e-01,       
     ...
     & 7.6867200e-02,2.9898452e-04,-6.1874539e-03/    
      ...
      data (recfit(147,j),j=1,9) /-1.2922370e01,-1.0179729e-01,       
     ...
     & 7.6580144e-02,2.9820623e-04,-6.1788936e-03/    
      ...
      data (recfit(148,j),j=1,9) /-1.2925926e01,-1.0003916e-01,       
     ...
     & 7.6202415e-02,2.9676565e-04,-6.1562588e-03/    
      ...
      data (recfit(149,j),j=1,9) /-1.2929485e01,-9.8309949e-02,       
     ...
     & 7.5904183e-02,2.9519698e-04,-6.1271158e-03/    
      ...
      data (recfit(150,j),j=1,9) /-1.2932901e01,-9.6801385e-02,       
     ...
     & 7.5636335e-02,2.9420515e-04,-6.1094943e-03/    
      ...
      data (recfit(151,j),j=1,9) /-1.2936206e01,-9.5662840e-02,       
     ...
     & 7.5403735e-02,2.9348064e-04,-6.0978094e-03/    
      ...
      data (recfit(152,j),j=1,9) /-1.2939630e01,-9.4225168e-02,       
     ...
     & 7.5085647e-02,2.9231334e-04,-6.0799159e-03/    
      ...
      data (recfit(153,j),j=1,9) /-1.2942921e01,-9.3507692e-02,       
     ...
     & 7.4668594e-02,2.9137413e-04,-6.0767657e-03/    
      ...
      data (recfit(154,j),j=1,9) /-1.2946257e01,-9.2675693e-02,       
     ...
     & 7.3932298e-02,2.8980157e-04,-6.0750726e-03/    
      ...
      data (recfit(155,j),j=1,9) /-1.2950015e01,-9.0391479e-02,       
     ...
     & 7.3074177e-02,2.8716898e-04,-6.0502202e-03/    
      ...
      data (recfit(156,j),j=1,9) /-1.2953408e01,-8.8867404e-02,       
     ...
     & 7.2694294e-02,2.8573457e-04,-6.0288389e-03/    
      ...
      data (recfit(157,j),j=1,9) /-1.2956943e01,-8.7976813e-02,       
     ...
     & 7.1391009e-02,2.8278027e-04,-6.0277963e-03/    
      ...
      data (recfit(158,j),j=1,9) /-1.2960416e01,-8.5727885e-02,       
     ...
     & 7.1024448e-02,2.8120971e-04,-5.9981486e-03/    
      ...
      data (recfit(159,j),j=1,9) /-1.2963779e01,-8.4199898e-02,       
     ...
     & 7.0735134e-02,2.7997163e-04,-5.9769265e-03/    
      ...
      data (recfit(160,j),j=1,9) /-1.2966952e01,-8.3230697e-02,       
     ...
     & 7.0515700e-02,2.7935259e-04,-5.9679970e-03/    
      ...
      data (recfit(161,j),j=1,9) /-1.2970169e01,-8.1922732e-02,       
     ...
     & 7.0345335e-02,2.7841030e-04,-5.9471731e-03/    
      ...
      data (recfit(162,j),j=1,9) /-1.2973417e01,-8.0568887e-02,       
     ...
     & 6.9985405e-02,2.7737793e-04,-5.9341961e-03/    
      ...
      data (recfit(163,j),j=1,9) /-1.2976655e01,-7.9133324e-02,       
     ...
     & 6.9844894e-02,2.7632061e-04,-5.9090154e-03/    
      ...
      data (recfit(164,j),j=1,9) /-1.2979909e01,-7.7718452e-02,       
     ...
     & 6.9619231e-02,2.7525748e-04,-5.8886558e-03/    
      ...
      data (recfit(165,j),j=1,9) /-1.2983279e01,-7.5756460e-02,       
     ...
     & 6.9178462e-02,2.7343514e-04,-5.8592604e-03/    
      ...
      data (recfit(166,j),j=1,9) /-1.2986597e01,-7.4546166e-02,       
     ...
     & 6.8380482e-02,2.7161685e-04,-5.8537601e-03/    
      ...
      data (recfit(167,j),j=1,9) /-1.2989790e01,-7.3429137e-02,       
     ...
     & 6.7870811e-02,2.7027668e-04,-5.8433427e-03/    
      ...
      data (recfit(168,j),j=1,9) /-1.2994373e01,-6.9232814e-02,       
     ...
     & 6.5177783e-02,2.6247231e-04,-5.7938080e-03/    
      ...
      data (recfit(169,j),j=1,9) /-1.2997371e01,-6.8472899e-02,       
     ...
     & 6.4876556e-02,2.6179751e-04,-5.7879491e-03/    
      ...
      data (recfit(170,j),j=1,9) /-1.3000412e01,-6.7792535e-02,       
     ...
     & 6.4542651e-02,2.6114471e-04,-5.7859533e-03/    
      ...
      data (recfit(171,j),j=1,9) /-1.3003260e01,-6.7829102e-02,       
     ...
     & 6.4087257e-02,2.6069206e-04,-5.7971510e-03/    
      ...
      data (recfit(172,j),j=1,9) /-1.3006524e01,-6.6123828e-02,       
     ...
     & 6.3542232e-02,2.5892514e-04,-5.7759113e-03/    
      ...
      data (recfit(173,j),j=1,9) /-1.3009602e01,-6.5535143e-02,       
     ...
     & 6.2621817e-02,2.5726823e-04,-5.7819127e-03/    
      ...
      data (recfit(174,j),j=1,9) /-1.3012690e01,-6.4464197e-02,       
     ...
     & 6.2281970e-02,2.5600567e-04,-5.7644141e-03/    
      ...
      data (recfit(175,j),j=1,9) /-1.3015742e01,-6.3292615e-02,       
     ...
     & 6.1965335e-02,2.5516644e-04,-5.7541276e-03/    
      ...
      data (recfit(176,j),j=1,9) /-1.3018823e01,-6.2251348e-02,       
     ...
     & 6.1454713e-02,2.5416550e-04,-5.7516024e-03/    
      ...
      data (recfit(177,j),j=1,9) /-1.3021775e01,-6.1349817e-02,       
     ...
     & 6.1261188e-02,2.5321500e-04,-5.7333452e-03/    
      ...
      data (recfit(178,j),j=1,9) /-1.3024689e01,-6.0537633e-02,       
     ...
     & 6.1106890e-02,2.5262887e-04,-5.7216748e-03/    
      ...
      data (recfit(179,j),j=1,9) /-1.3027586e01,-5.9678543e-02,       
     ...
     & 6.1000217e-02,2.5199380e-04,-5.7059913e-03/    
      ...
      data (recfit(180,j),j=1,9) /-1.3031168e01,-5.6708992e-02,       
     ...
     & 6.0328782e-02,2.4945661e-04,-5.6706360e-03/    
      ...
      data (recfit(181,j),j=1,9) /-1.3034077e01,-5.5576283e-02,       
     ...
     & 6.0086787e-02,2.4843679e-04,-5.6511429e-03/    
      ...
      data (recfit(182,j),j=1,9) /-1.3037005e01,-5.4630835e-02,       
     ...
     & 5.9833918e-02,2.4763323e-04,-5.6392886e-03/    
      ...
      data (recfit(183,j),j=1,9) /-1.3039930e01,-5.3878319e-02,       
     ...
     & 5.9475660e-02,2.4669591e-04,-5.6312443e-03/    
      ...
      data (recfit(184,j),j=1,9) /-1.3042773e01,-5.3207684e-02,       
     ...
     & 5.9135381e-02,2.4599661e-04,-5.6269937e-03/    
      ...
      data (recfit(185,j),j=1,9) /-1.3045631e01,-5.2361719e-02,       
     ...
     & 5.8981530e-02,2.4538484e-04,-5.6145983e-03/    
      ...
      data (recfit(186,j),j=1,9) /-1.3048620e01,-5.0999772e-02,       
     ...
     & 5.8867689e-02,2.4435803e-04,-5.5894139e-03/    
      ...
      data (recfit(187,j),j=1,9) /-1.3051424e01,-5.0298367e-02,       
     ...
     & 5.8638353e-02,2.4388103e-04,-5.5841473e-03/    
      ...
      data (recfit(188,j),j=1,9) /-1.3054798e01,-4.8396397e-02,       
     & 1.0560801e00,2.5615320e-02,-5.5606204e-01,-1.9646869e-03,           
     & 5.7181526e-02,2.4031432e-04,-5.5700387e-03/    
		       
		       
      data (recfit(189,j),j=1,9) /-1.3057538e01,-4.7986466e-02,       
     ...
     & 5.6948952e-02,2.3983984e-04,-5.5664838e-03/    
      ...
      data (recfit(190,j),j=1,9) /-1.3060360e01,-4.7135577e-02,       
     ...
     & 5.6803722e-02,2.3925587e-04,-5.5543855e-03/    
      ...
      data (recfit(191,j),j=1,9) /-1.3063112e01,-4.6454512e-02,       
     ...
     & 5.6707036e-02,2.3886634e-04,-5.5445228e-03/    
      ...
      data (recfit(192,j),j=1,9) /-1.3065994e01,-4.5264028e-02,       
     ...
     & 5.6615263e-02,2.3813079e-04,-5.5251624e-03/    
      ...
      data (recfit(193,j),j=1,9) /-1.3068822e01,-4.4381630e-02,       
     ...
     & 5.6266703e-02,2.3712622e-04,-5.5136797e-03/    
      ...
      data (recfit(194,j),j=1,9) /-1.3071781e01,-4.2990677e-02,       
     ...
     & 5.5910721e-02,2.3590148e-04,-5.4963217e-03/    
      ...
      data (recfit(195,j),j=1,9) /-1.3074587e01,-4.2212937e-02,       
     ...
     & 5.5485237e-02,2.3487664e-04,-5.4888208e-03/    
      ...
      data (recfit(196,j),j=1,9) /-1.3077398e01,-4.1054782e-02,       
     ...
     & 5.5445764e-02,2.3424011e-04,-5.4687210e-03/    
      ...
      data (recfit(197,j),j=1,9) /-1.3080053e01,-4.0832713e-02,       
     ...
     & 5.5167668e-02,2.3382150e-04,-5.4696943e-03/    
      ...
      data (recfit(198,j),j=1,9) /-1.3084186e01,-3.7503101e-02,       
     ...
     & 5.1408544e-02,2.2518923e-04,-5.4567936e-03/    
      ...
      data (recfit(199,j),j=1,9) /-1.3086956e01,-3.7329234e-02,       
     ...
     & 5.0344542e-02,2.2359312e-04,-5.4717502e-03/    
      ...
      data (recfit(200,j),j=1,9) /-1.3089603e01,-3.7013296e-02,       
     ...
     & 4.9938835e-02,2.2263105e-04,-5.4658791e-03/    
      ...
      data (recfit(201,j),j=1,9) /-1.3092388e01,-3.6613312e-02,       
     ...
     & 4.9429540e-02,2.2147842e-04,-5.4628281e-03/    
      ...
      data (recfit(202,j),j=1,9) /-1.3095132e01,-3.5684671e-02,       
     ...
     & 4.9243122e-02,2.2101958e-04,-5.4551652e-03/    
      ...
      data (recfit(203,j),j=1,9) /-1.3097836e01,-3.4898277e-02,       
     ...
     & 4.9138360e-02,2.2015675e-04,-5.4348572e-03/    
      ...
      data (recfit(204,j),j=1,9) /-1.3100678e01,-3.3545244e-02,       
     ...
     & 4.8546895e-02,2.1858729e-04,-5.4203244e-03/    
      ...
      data (recfit(205,j),j=1,9) /-1.3103742e01,-3.0996004e-02,       
     ...
     & 4.8375625e-02,2.1718058e-04,-5.3848224e-03/    
      ...
      data (recfit(206,j),j=1,9) /-1.3106484e01,-2.9996075e-02,       
     ...
     & 4.8120461e-02,2.1631015e-04,-5.3711827e-03/    
      ...
      data (recfit(207,j),j=1,9) /-1.3109170e01,-2.9401589e-02,       
     ...
     & 4.7724154e-02,2.1549418e-04,-5.3677033e-03/    
      ...
      data (recfit(208,j),j=1,9) /-1.3111835e01,-2.8596591e-02,       
     ...
     & 4.7568917e-02,2.1484101e-04,-5.3545022e-03/    
      ...
      data (recfit(209,j),j=1,9) /-1.3114451e01,-2.8021712e-02,       
     ...
     & 4.7393683e-02,2.1434083e-04,-5.3466437e-03/    
      ...
      data (recfit(210,j),j=1,9) /-1.3117069e01,-2.7390355e-02,       
     ...
     & 4.7225296e-02,2.1383847e-04,-5.3381613e-03/    
      ...
      data (recfit(211,j),j=1,9) /-1.3119642e01,-2.6827678e-02,       
     ...
     & 4.7154587e-02,2.1343310e-04,-5.3269491e-03/    
      ...
      data (recfit(212,j),j=1,9) /-1.3122627e01,-2.4786793e-02,       
     ...
     & 4.6536803e-02,2.1127122e-04,-5.2991458e-03/    
      ...
      data (recfit(213,j),j=1,9) /-1.3126088e01,-2.1792339e-02,       
     ...
     & 4.4500880e-02,2.0635551e-04,-5.2790716e-03/    
      ...
      data (recfit(214,j),j=1,9) /-1.3128549e01,-2.1782210e-02,       
     ...
     & 4.4369794e-02,2.0612964e-04,-5.2771848e-03/    
      ...
      data (recfit(215,j),j=1,9) /-1.3130976e01,-2.1724079e-02,       
     ...
     & 4.4247556e-02,2.0576685e-04,-5.2707074e-03/    
      ...
      data (recfit(216,j),j=1,9) /-1.3133466e01,-2.1663373e-02,       
     ...
     & 4.4145171e-02,2.0565845e-04,-5.2706273e-03/    
      ...
      data (recfit(217,j),j=1,9) /-1.3135907e01,-2.1633258e-02,       
     ...
     & 4.4071436e-02,2.0540993e-04,-5.2652583e-03/    
      ...
      data (recfit(218,j),j=1,9) /-1.3138672e01,-2.0304639e-02,       
     ...
     & 4.3565512e-02,2.0421870e-04,-5.2559432e-03/    
      ...
      data (recfit(219,j),j=1,9) /-1.3141154e01,-2.0029264e-02,       
     ...
     & 4.3452870e-02,2.0390841e-04,-5.2502602e-03/    
      ...
      data (recfit(220,j),j=1,9) /-1.3143664e01,-1.9739542e-02,       
     ...
     & 4.3168984e-02,2.0335412e-04,-5.2477098e-03/    
      ...
      data (recfit(221,j),j=1,9) /-1.3146100e01,-1.9568518e-02,       
     ...
     & 4.3103468e-02,2.0311653e-04,-5.2415049e-03/    
      ...
      data (recfit(222,j),j=1,9) /-1.3148540e01,-1.9432614e-02,       
     ...
     & 4.2987730e-02,2.0285635e-04,-5.2376096e-03/    
      ...
      data (recfit(223,j),j=1,9) /-1.3150968e01,-1.9343788e-02,       
     ...
     & 4.2907432e-02,2.0265492e-04,-5.2334894e-03/    
      ...
      data (recfit(224,j),j=1,9) /-1.3153507e01,-1.8464608e-02,       
     ...
     & 4.2769868e-02,2.0211814e-04,-5.2211611e-03/    
      ...
      data (recfit(225,j),j=1,9) /-1.3155905e01,-1.8441848e-02,       
     ...
     & 4.2650033e-02,2.0182622e-04,-5.2170381e-03/    
      ...
      data (recfit(226,j),j=1,9) /-1.3158326e01,-1.8335026e-02,       
     ...
     & 4.2591255e-02,2.0164398e-04,-5.2125729e-03/    
      ...
      data (recfit(227,j),j=1,9) /-1.3160786e01,-1.8198408e-02,       
     ...
     & 4.2175617e-02,2.0085413e-04,-5.2117007e-03/    
      ...
      data (recfit(228,j),j=1,9) /-1.3164427e01,-1.1986890e-02,       
     ...
     & 4.1586533e-02,1.9695863e-04,-5.1288703e-03/    
      ...
      data (recfit(229,j),j=1,9) /-1.3166804e01,-1.1901799e-02,       
     ...
     & 4.1474923e-02,1.9676672e-04,-5.1262407e-03/    
      ...
      data (recfit(230,j),j=1,9) /-1.3169178e01,-1.1852906e-02,       
     ...
     & 4.1364525e-02,1.9658523e-04,-5.1241680e-03/    
      ...
      data (recfit(231,j),j=1,9) /-1.3171542e01,-1.1817374e-02,       
     ...
     & 4.1271280e-02,1.9636675e-04,-5.1204315e-03/    
      ...
      data (recfit(232,j),j=1,9) /-1.3173882e01,-1.1846778e-02,       
     ...
     & 4.1174076e-02,1.9616346e-04,-5.1172795e-03/    
      ...
      data (recfit(233,j),j=1,9) /-1.3176305e01,-1.1606558e-02,       
     ...
     & 4.1036014e-02,1.9596161e-04,-5.1159482e-03/    
      ...
      data (recfit(234,j),j=1,9) /-1.3178675e01,-1.1390689e-02,       
     ...
     & 4.0969651e-02,1.9568326e-04,-5.1087299e-03/    
      ...
      data (recfit(235,j),j=1,9) /-1.3181014e01,-1.1251786e-02,       
     ...
     & 4.0937424e-02,1.9551867e-04,-5.1024719e-03/    
      ...
      data (recfit(236,j),j=1,9) /-1.3183327e01,-1.1277574e-02,       
     ...
     & 4.0881682e-02,1.9532644e-04,-5.0974791e-03/    
      ...
      data (recfit(237,j),j=1,9) /-1.3185724e01,-1.0871968e-02,       
     ...
     & 4.0814169e-02,1.9517577e-04,-5.0926777e-03/    
      ...
      data (recfit(238,j),j=1,9) /-1.3188044e01,-1.0823163e-02,       
     ...
     & 4.0750466e-02,1.9491515e-04,-5.0863549e-03/    
      ...
      data (recfit(239,j),j=1,9) /-1.3190366e01,-1.0752993e-02,       
     ...
     & 4.0683337e-02,1.9464413e-04,-5.0799223e-03/    
      ...
      data (recfit(240,j),j=1,9) /-1.3192693e01,-1.0740140e-02,       
     ...
     & 4.0548787e-02,1.9455553e-04,-5.0813369e-03/    
      ...
      data (recfit(241,j),j=1,9) /-1.3195190e01,-9.7072888e-03,       
     ...
     & 4.0476743e-02,1.9398899e-04,-5.0654854e-03/    
      ...
      data (recfit(242,j),j=1,9) /-1.3198017e01,-7.1791112e-03,       
     ...
     & 4.0252864e-02,1.9328151e-04,-5.0499164e-03/    
      ...
      data (recfit(243,j),j=1,9) /-1.3200281e01,-7.1573881e-03,       
     ...
     & 4.0199120e-02,1.9291339e-04,-5.0402354e-03/    
      ...
      data (recfit(244,j),j=1,9) /-1.3202567e01,-7.1133603e-03,       
     ...
     & 4.0136226e-02,1.9263318e-04,-5.0334241e-03/    
      ...
      data (recfit(245,j),j=1,9) /-1.3204932e01,-6.4961631e-03,       
     ...
     & 4.0192436e-02,1.9210628e-04,-5.0132163e-03/    
      ...
      data (recfit(246,j),j=1,9) /-1.3207204e01,-6.4880061e-03,       
     ...
     & 4.0136088e-02,1.9187114e-04,-5.0072474e-03/    
      ...
      data (recfit(247,j),j=1,9) /-1.3209503e01,-6.4052162e-03,       
     ...
     & 4.0027708e-02,1.9170826e-04,-5.0055399e-03/    
      ...
      data (recfit(248,j),j=1,9) /-1.3211766e01,-6.3896747e-03,       
     ...
     & 3.9963137e-02,1.9144527e-04,-4.9992329e-03/    
      ...
      data (recfit(249,j),j=1,9) /-1.3214051e01,-6.2836045e-03,       
     ...
     & 3.9880615e-02,1.9118447e-04,-4.9937619e-03/    
      ...
      data (recfit(250,j),j=1,9) /-1.3216320e01,-6.2085832e-03,       
     ...
     & 3.9780039e-02,1.9089734e-04,-4.9885544e-03/    
      ...
      data (recfit(251,j),j=1,9) /-1.3219804e01,-8.3094143e-04,       
     ...
     & 3.8309339e-02,1.8707608e-04,-4.9559507e-03/    
      ...
      data (recfit(252,j),j=1,9) /-1.3222052e01,-8.2665752e-04,       
     ...
     & 3.8269803e-02,1.8677131e-04,-4.9477997e-03/    
      ...
      data (recfit(253,j),j=1,9) /-1.3224281e01,-8.2145236e-04,       
     ...
     & 3.8234897e-02,1.8647456e-04,-4.9394039e-03/    
      ...
      data (recfit(254,j),j=1,9) /-1.3226524e01,-8.1961689e-04,       
     ...
     & 3.8142975e-02,1.8615567e-04,-4.9334988e-03/    
      ...
      data (recfit(255,j),j=1,9) /-1.3228744e01,-8.1255275e-04,       
     ...
     & 3.8067918e-02,1.8578689e-04,-4.9252193e-03/    
      ...
      data (recfit(256,j),j=1,9) /-1.3230975e01,-8.0201513e-04,       
     ...
     & 3.7995718e-02,1.8552488e-04,-4.9195485e-03/    
      ...
      data (recfit(257,j),j=1,9) /-1.3233188e01,-7.9763756e-04,       
     ...
     & 3.7922163e-02,1.8525014e-04,-4.9133282e-03/    
      ...
      data (recfit(258,j),j=1,9) /-1.3235422e01,-7.8033918e-04,       
     ...
     & 3.7828583e-02,1.8509531e-04,-4.9113375e-03/    
      ...
      data (recfit(259,j),j=1,9) /-1.3237631e01,-7.8221509e-04,       
     ...
     & 3.7747409e-02,1.8477956e-04,-4.9046990e-03/    
      ...
      data (recfit(260,j),j=1,9) /-1.3239866e01,-7.7661587e-04,       
     ...
     & 3.7638478e-02,1.8455279e-04,-4.9021095e-03/    
      ...
      data (recfit(261,j),j=1,9) /-1.3242065e01,-7.7587500e-04,       
     ...
     & 3.7567075e-02,1.8428953e-04,-4.8961658e-03/    
      ...
      data (recfit(262,j),j=1,9) /-1.3244277e01,-7.7473716e-04,       
     ...
     & 3.7491769e-02,1.8407908e-04,-4.8919981e-03/    
      ...
      data (recfit(263,j),j=1,9) /-1.3246514e01,-7.6982356e-04,       
     ...
     & 3.7374150e-02,1.8397857e-04,-4.8931879e-03/    
      ...
      data (recfit(264,j),j=1,9) /-1.3248674e01,-7.6786662e-04,       
     ...
     & 3.7258577e-02,1.8353549e-04,-4.8844139e-03/    
      ...
      data (recfit(265,j),j=1,9) /-1.3250866e01,-7.6698826e-04,       
     ...
     & 3.7173793e-02,1.8331234e-04,-4.8802532e-03/    
      ...
      data (recfit(266,j),j=1,9) /-1.3253060e01,-7.6706550e-04,       
     ...
     & 3.7106588e-02,1.8314648e-04,-4.8767943e-03/    
      ...
      data (recfit(267,j),j=1,9) /-1.3255239e01,-7.6635060e-04,       
     ...
     & 3.7028316e-02,1.8290862e-04,-4.8718541e-03/    
      ...
      data (recfit(268,j),j=1,9) /-1.3257406e01,-7.6270301e-04,       
     ...
     & 3.6897313e-02,1.8258177e-04,-4.8669172e-03/    
      ...
      data (recfit(269,j),j=1,9) /-1.3259604e01,-7.6197751e-04,       
     ...
     & 3.6842607e-02,1.8252357e-04,-4.8659579e-03/    
      ...
      data (recfit(270,j),j=1,9) /-1.3261773e01,-7.6131657e-04,       
     ...
     & 3.6753304e-02,1.8223225e-04,-4.8602796e-03/    
      ...
      data (recfit(271,j),j=1,9) /-1.3263946e01,-7.6055585e-04,       
     ...
     & 3.6695331e-02,1.8209773e-04,-4.8571369e-03/    
      ...
      data (recfit(272,j),j=1,9) /-1.3266154e01,-7.4938894e-04,       
     ...
     & 3.6628854e-02,1.8193998e-04,-4.8542800e-03/    
      ...
      data (recfit(273,j),j=1,9) /-1.3268272e01,-7.4989401e-04,       
     ...
     & 3.6539260e-02,1.8170584e-04,-4.8495396e-03/    
      ...
      data (recfit(274,j),j=1,9) /-1.3270416e01,-7.4682286e-04,       
     ...
     & 3.6482181e-02,1.8143585e-04,-4.8427745e-03/    
      ...
      data (recfit(275,j),j=1,9) /-1.3272562e01,-7.4775046e-04,       
     ...
     & 3.6420766e-02,1.8122388e-04,-4.8377509e-03/    
      ...
      data (recfit(276,j),j=1,9) /-1.3274715e01,-7.4409379e-04,       
     ...
     & 3.6351468e-02,1.8102983e-04,-4.8336703e-03/    
      ...
      data (recfit(277,j),j=1,9) /-1.3276862e01,-7.3208753e-04,       
     ...
     & 3.6260229e-02,1.8078032e-04,-4.8292326e-03/    
      ...
      data (recfit(278,j),j=1,9) /-1.3279005e01,-7.2463247e-04,       
     ...
     & 3.6181431e-02,1.8057832e-04,-4.8253858e-03/    
      ...
      data (recfit(279,j),j=1,9) /-1.3281138e01,-7.2414626e-04,       
     ...
     & 3.6124296e-02,1.8036173e-04,-4.8200982e-03/    
      ...
      data (recfit(280,j),j=1,9) /-1.3283271e01,-7.2541944e-04,       
     ...
     & 3.6040924e-02,1.8021531e-04,-4.8176800e-03/    
      ...
      data (recfit(281,j),j=1,9) /-1.3285397e01,-7.2328729e-04,       
     ...
     & 3.5962638e-02,1.7998186e-04,-4.8130103e-03/    
      ...
      data (recfit(282,j),j=1,9) /-1.3287514e01,-7.2373607e-04,       
     ...
     & 3.5912123e-02,1.7976992e-04,-4.8074829e-03/    
      ...
      data (recfit(283,j),j=1,9) /-1.3289632e01,-7.2179240e-04,       
     ...
     & 3.5840303e-02,1.7955374e-04,-4.8028813e-03/    
      ...
      data (recfit(284,j),j=1,9) /-1.3291748e01,-7.1921229e-04,       
     ...
     & 3.5771307e-02,1.7929859e-04,-4.7972943e-03/    
      ...
      data (recfit(285,j),j=1,9) /-1.3293864e01,-7.1916747e-04,       
     ...
     & 3.5691325e-02,1.7914933e-04,-4.7947778e-03/    
      ...
      data (recfit(286,j),j=1,9) /-1.3295978e01,-7.1638305e-04,       
     ...
     & 3.5615344e-02,1.7894122e-04,-4.7906698e-03/    
      ...
      data (recfit(287,j),j=1,9) /-1.3298111e01,-7.1157719e-04,       
     ...
     & 3.5399422e-02,1.7874957e-04,-4.7937366e-03/    
      ...
      data (recfit(288,j),j=1,9) /-1.3300211e01,-7.0996478e-04,       
     ...
     & 3.5342693e-02,1.7853112e-04,-4.7884570e-03/    
      ...
      data (recfit(289,j),j=1,9) /-1.3302302e01,-7.0314389e-04,       
     ...
     & 3.5285067e-02,1.7829708e-04,-4.7827670e-03/    
      ...
      data (recfit(290,j),j=1,9) /-1.3304389e01,-7.0238649e-04,       
     ...
     & 3.5234705e-02,1.7806100e-04,-4.7767097e-03/    
      ...
      data (recfit(291,j),j=1,9) /-1.3306476e01,-7.0066412e-04,       
     ...
     & 3.5188518e-02,1.7784169e-04,-4.7709127e-03/    
      ...
      data (recfit(292,j),j=1,9) /-1.3308562e01,-6.9839024e-04,       
     ...
     & 3.5129134e-02,1.7765714e-04,-4.7665513e-03/    
      ...
      data (recfit(293,j),j=1,9) /-1.3310640e01,-6.8606721e-04,       
     ...
     & 3.5059165e-02,1.7742314e-04,-4.7614411e-03/    
      ...
      data (recfit(294,j),j=1,9) /-1.3312718e01,-6.8443635e-04,       
     ...
     & 3.4994066e-02,1.7722219e-04,-4.7569526e-03/    
      ...
      data (recfit(295,j),j=1,9) /-1.3314791e01,-6.8401627e-04,       
     ...
     & 3.4937967e-02,1.7702823e-04,-4.7521754e-03/    
      ...
      data (recfit(296,j),j=1,9) /-1.3316862e01,-6.8413402e-04,       
     ...
     & 3.4866169e-02,1.7682857e-04,-4.7481353e-03/    
      ...
      data (recfit(297,j),j=1,9) /-1.3318931e01,-6.8457774e-04,       
     ...
     & 3.4805600e-02,1.7660984e-04,-4.7430275e-03/    
      ...
      data (recfit(298,j),j=1,9) /-1.3321024e01,-6.9219188e-04,       
     ...
     & 3.4753792e-02,1.7654235e-04,-4.7415416e-03/    
      ...
      data (recfit(299,j),j=1,9) /-1.3323061e01,-6.9039548e-04,       
     ...
     & 3.4676809e-02,1.7638467e-04,-4.7381804e-03/    
      ...
      data (recfit(300,j),j=1,9) /-1.3325114e01,-6.8570761e-04,       
     ...
     & 3.4610856e-02,1.7616407e-04,-4.7333441e-03/    
      ...
      data (recfit(301,j),j=1,9) /-1.3327168e01,-6.8333244e-04,       
     ...
     & 3.4558099e-02,1.7594516e-04,-4.7279513e-03/    
      ...
      data (recfit(302,j),j=1,9) /-1.3329213e01,-6.8286801e-04,       
     ...
     & 3.4514062e-02,1.7576176e-04,-4.7228807e-03/    
      ...
      data (recfit(303,j),j=1,9) /-1.3331262e01,-6.8112818e-04,       
     ...
     & 3.4450054e-02,1.7556766e-04,-4.7186059e-03/    
      ...
      data (recfit(304,j),j=1,9) /-1.3333305e01,-6.8009045e-04,       
     ...
     & 3.4384597e-02,1.7537260e-04,-4.7143647e-03/    
      ...
      data (recfit(305,j),j=1,9) /-1.3335341e01,-6.7798776e-04,       
     ...
     & 3.4329690e-02,1.7520291e-04,-4.7101439e-03/    
      ...
      data (recfit(306,j),j=1,9) /-1.3337382e01,-6.7299634e-04,       
     ...
     & 3.4279492e-02,1.7498007e-04,-4.7045299e-03/    
      ...
      data (recfit(307,j),j=1,9) /-1.3339415e01,-6.6342711e-04,       
     ...
     & 3.4132324e-02,1.7467278e-04,-4.7014994e-03/    
      ...
      data (recfit(308,j),j=1,9) /-1.3341439e01,-6.6059188e-04,       
     ...
     & 3.4072679e-02,1.7444849e-04,-4.6962206e-03/    
      ...
      data (recfit(309,j),j=1,9) /-1.3343461e01,-6.5792468e-04,       
     ...
     & 3.4016114e-02,1.7419273e-04,-4.6901372e-03/    
      ...
      data (recfit(310,j),j=1,9) /-1.3345473e01,-6.5459608e-04,       
     ...
     & 3.3956595e-02,1.7395485e-04,-4.6844743e-03/    
      ...
      data (recfit(311,j),j=1,9) /-1.3347496e01,-6.5362640e-04,       
     ...
     & 3.3903334e-02,1.7375243e-04,-4.6796510e-03/    
      ...
      data (recfit(312,j),j=1,9) /-1.3349520e01,-6.4906600e-04,       
     ...
     & 3.3818189e-02,1.7354758e-04,-4.6763285e-03/    
      ...
      data (recfit(313,j),j=1,9) /-1.3351519e01,-6.4685661e-04,       
     ...
     & 3.3736717e-02,1.7323349e-04,-4.6698241e-03/    
      ...
      data (recfit(314,j),j=1,9) /-1.3353528e01,-6.4423436e-04,       
     ...
     & 3.3666797e-02,1.7299831e-04,-4.6649375e-03/    
      ...
      data (recfit(315,j),j=1,9) /-1.3355539e01,-6.4398092e-04,       
     ...
     & 3.3610597e-02,1.7280941e-04,-4.6605817e-03/    
      ...
      data (recfit(316,j),j=1,9) /-1.3357540e01,-6.4337399e-04,       
     ...
     & 3.3523131e-02,1.7260655e-04,-4.6572061e-03/    
      ...
      data (recfit(317,j),j=1,9) /-1.3359543e01,-6.4163830e-04,       
     ...
     & 3.3467337e-02,1.7241320e-04,-4.6526566e-03/    
      ...
      data (recfit(318,j),j=1,9) /-1.3361534e01,-6.3993782e-04,       
     ...
     & 3.3408754e-02,1.7220073e-04,-4.6477490e-03/    
      ...
      data (recfit(319,j),j=1,9) /-1.3363512e01,-6.3811243e-04,       
     ...
     & 3.3360671e-02,1.7199689e-04,-4.6423408e-03/    
      ...
      data (recfit(320,j),j=1,9) /-1.3365514e01,-6.3873112e-04,       
     ...
     & 3.3298705e-02,1.7181796e-04,-4.6386141e-03/    
      ...
      data (recfit(321,j),j=1,9) /-1.3367488e01,-6.3719816e-04,       
     ...
     & 3.3220313e-02,1.7155833e-04,-4.6333820e-03/    
      ...
      data (recfit(322,j),j=1,9) /-1.3369480e01,-6.3675677e-04,       
     ...
     & 3.3145152e-02,1.7133885e-04,-4.6292916e-03/    
      ...
      data (recfit(323,j),j=1,9) /-1.3371452e01,-6.3471007e-04,       
     ...
     & 3.3085931e-02,1.7111596e-04,-4.6241856e-03/    
      ...
      data (recfit(324,j),j=1,9) /-1.3373438e01,-6.3167274e-04,       
     ...
     & 3.3020388e-02,1.7092931e-04,-4.6204114e-03/    
      ...
      data (recfit(325,j),j=1,9) /-1.3375402e01,-6.2763580e-04,       
     ...
     & 3.2927018e-02,1.7065652e-04,-4.6155471e-03/    
      ...
      data (recfit(326,j),j=1,9) /-1.3377335e01,-6.0663017e-04,       
     ...
     & 3.2852635e-02,1.7031492e-04,-4.6075252e-03/    
      ...
      data (recfit(327,j),j=1,9) /-1.3379336e01,-6.0534716e-04,       
     ...
     & 3.2808758e-02,1.7021863e-04,-4.6055024e-03/    
      ...
      data (recfit(328,j),j=1,9) /-1.3381303e01,-5.8850710e-04,       
     ...
     & 3.2757048e-02,1.7001665e-04,-4.6006567e-03/    
      ...
      data (recfit(329,j),j=1,9) /-1.3383256e01,-5.8878894e-04,       
     ...
     & 3.2702781e-02,1.6983029e-04,-4.5961211e-03/    
      ...
      data (recfit(330,j),j=1,9) /-1.3385196e01,-5.8889500e-04,       
     ...
     & 3.2658398e-02,1.6961477e-04,-4.5902194e-03/    
      ...
      data (recfit(331,j),j=1,9) /-1.3387143e01,-5.8821723e-04,       
     ...
     & 3.2616150e-02,1.6940940e-04,-4.5847944e-03/    
      ...
      data (recfit(332,j),j=1,9) /-1.3389093e01,-5.9045834e-04,       
     ...
     & 3.2555372e-02,1.6917952e-04,-4.5796856e-03/    
      ...
      data (recfit(333,j),j=1,9) /-1.3391018e01,-5.8387528e-04,       
     ...
     & 3.2494403e-02,1.6893038e-04,-4.5737163e-03/    
      ...
      data (recfit(334,j),j=1,9) /-1.3392981e01,-5.8193255e-04,       
     ...
     & 3.2459758e-02,1.6879344e-04,-4.5700083e-03/    
      ...
      data (recfit(335,j),j=1,9) /-1.3394905e01,-5.8407109e-04,       
     ...
     & 3.2411881e-02,1.6851618e-04,-4.5629749e-03/    
      ...
      data (recfit(336,j),j=1,9) /-1.3396842e01,-5.8410002e-04,       
     ...
     & 3.2365590e-02,1.6831883e-04,-4.5580305e-03/    
      ...
      data (recfit(337,j),j=1,9) /-1.3398787e01,-5.8474776e-04,       
     ...
     & 3.2318000e-02,1.6819101e-04,-4.5548943e-03/    
      ...
      data (recfit(338,j),j=1,9) /-1.3400708e01,-5.8316148e-04,       
     ...
     & 3.2201663e-02,1.6785174e-04,-4.5495923e-03/    
      ...
      data (recfit(339,j),j=1,9) /-1.3402897e01,-5.9998850e-04,       
     ...
     & 3.0373884e-02,1.6561423e-04,-4.5829816e-03/    
      ...
      data (recfit(340,j),j=1,9) /-1.3404808e01,-5.9558300e-04,       
     ...
     & 3.0331738e-02,1.6539171e-04,-4.5769759e-03/    
      ...
      data (recfit(341,j),j=1,9) /-1.3406730e01,-5.9095293e-04,       
     ...
     & 3.0293126e-02,1.6518046e-04,-4.5713070e-03/    
      ...
      data (recfit(342,j),j=1,9) /-1.3408638e01,-5.8064883e-04,       
     ...
     & 3.0256612e-02,1.6494616e-04,-4.5648599e-03/    
      ...
      data (recfit(343,j),j=1,9) /-1.3410547e01,-5.7923497e-04,       
     ...
     & 3.0220067e-02,1.6473178e-04,-4.5590117e-03/    
      ...
      data (recfit(344,j),j=1,9) /-1.3412461e01,-5.7871698e-04,       
     ...
     & 3.0176738e-02,1.6451425e-04,-4.5534219e-03/    
      ...
      data (recfit(345,j),j=1,9) /-1.3414354e01,-5.7856692e-04,       
     ...
     & 3.0131448e-02,1.6426267e-04,-4.5469161e-03/    
      ...
      data (recfit(346,j),j=1,9) /-1.3416247e01,-5.7491352e-04,       
     ...
     & 3.0090371e-02,1.6402134e-04,-4.5405612e-03/    
      ...
      data (recfit(347,j),j=1,9) /-1.3418148e01,-5.7412992e-04,       
     ...
     & 3.0049451e-02,1.6382139e-04,-4.5352685e-03/    
      ...
      data (recfit(348,j),j=1,9) /-1.3420036e01,-5.6813494e-04,       
     ...
     & 3.0007513e-02,1.6357032e-04,-4.5285807e-03/    
      ...
      data (recfit(349,j),j=1,9) /-1.3421936e01,-5.6752085e-04,       
     ...
     & 2.9968787e-02,1.6339066e-04,-4.5237849e-03/    
      ...
      data (recfit(350,j),j=1,9) /-1.3423819e01,-5.6533731e-04,       
     ...
     & 2.9921787e-02,1.6319643e-04,-4.5187967e-03/    
      ...
      data (recfit(351,j),j=1,9) /-1.3425708e01,-5.6360610e-04,       
     ...
     & 2.9881123e-02,1.6300114e-04,-4.5136078e-03/    
      ...
      data (recfit(352,j),j=1,9) /-1.3427589e01,-5.5677549e-04,       
     ...
     & 2.9841229e-02,1.6279097e-04,-4.5079994e-03/    
      ...
      data (recfit(353,j),j=1,9) /-1.3429470e01,-5.5960112e-04,       
     ...
     & 2.9805183e-02,1.6258843e-04,-4.5024343e-03/    
      ...
      data (recfit(354,j),j=1,9) /-1.3431344e01,-5.6105340e-04,       
     ...
     & 2.9767314e-02,1.6238568e-04,-4.4969148e-03/    
      ...
      data (recfit(355,j),j=1,9) /-1.3433219e01,-5.6162011e-04,       
     ...
     & 2.9724862e-02,1.6217942e-04,-4.4915434e-03/    
      ...
      data (recfit(356,j),j=1,9) /-1.3435085e01,-5.4627762e-04,       
     ...
     & 2.9692220e-02,1.6196092e-04,-4.4853692e-03/    
      ...
      data (recfit(357,j),j=1,9) /-1.3436959e01,-5.4430892e-04,       
     ...
     & 2.9654274e-02,1.6176738e-04,-4.4801794e-03/    
      ...
      data (recfit(358,j),j=1,9) /-1.3438821e01,-5.4146082e-04,       
     ...
     & 2.9611800e-02,1.6155244e-04,-4.4745221e-03/    
      ...
      data (recfit(359,j),j=1,9) /-1.3440679e01,-5.4033770e-04,       
     ...
     & 2.9570058e-02,1.6135514e-04,-4.4693430e-03/    
      ...
      data (recfit(360,j),j=1,9) /-1.3442543e01,-5.3498452e-04,       
     ...
     & 2.9531173e-02,1.6117093e-04,-4.4644084e-03/    
      ...
      data (recfit(361,j),j=1,9) /-1.3444395e01,-5.3274946e-04,       
     ...
     & 2.9490998e-02,1.6095283e-04,-4.4586072e-03/    
      ...
      data (recfit(362,j),j=1,9) /-1.3446251e01,-5.3106959e-04,       
     ...
     & 2.9451221e-02,1.6075018e-04,-4.4532917e-03/    
      ...
      data (recfit(363,j),j=1,9) /-1.3448102e01,-5.2851939e-04,       
     ...
     & 2.9412365e-02,1.6055124e-04,-4.4479524e-03/    
      ...
      data (recfit(364,j),j=1,9) /-1.3449940e01,-5.2841200e-04,       
     ...
     & 2.9371742e-02,1.6033644e-04,-4.4422662e-03/    
      ...
      data (recfit(365,j),j=1,9) /-1.3451788e01,-5.2516325e-04,       
     ...
     & 2.9326860e-02,1.6013913e-04,-4.4372799e-03/    
      ...
      data (recfit(366,j),j=1,9) /-1.3453640e01,-5.2437029e-04,       
     ...
     & 2.9288430e-02,1.5995430e-04,-4.4324310e-03/    
      ...
      data (recfit(367,j),j=1,9) /-1.3455469e01,-5.2365393e-04,       
     ...
     & 2.9245827e-02,1.5974564e-04,-4.4269739e-03/    
      ...
      data (recfit(368,j),j=1,9) /-1.3457305e01,-5.2595424e-04,       
     ...
     & 2.9201243e-02,1.5953783e-04,-4.4217459e-03/    
      ...
      data (recfit(369,j),j=1,9) /-1.3459147e01,-5.2699505e-04,       
     ...
     & 2.9160999e-02,1.5935594e-04,-4.4170367e-03/    
      ...
      data (recfit(370,j),j=1,9) /-1.3460976e01,-5.2605453e-04,       
     ...
     & 2.9113211e-02,1.5917842e-04,-4.4125891e-03/    
      ...
      data (recfit(371,j),j=1,9) /-1.3462813e01,-5.2376068e-04,       
     ...
     & 2.9064225e-02,1.5904113e-04,-4.4093542e-03/    
      ...
      data (recfit(372,j),j=1,9) /-1.3464632e01,-5.2468892e-04,       
     ...
     & 2.9025577e-02,1.5881509e-04,-4.4033835e-03/    
      ...
      data (recfit(373,j),j=1,9) /-1.3466458e01,-5.2301114e-04,       
     ...
     & 2.8986817e-02,1.5863118e-04,-4.3984973e-03/    
      ...
      data (recfit(374,j),j=1,9) /-1.3468272e01,-5.2184315e-04,       
     ...
     & 2.8953008e-02,1.5842298e-04,-4.3927473e-03/    
      ...
      data (recfit(375,j),j=1,9) /-1.3470092e01,-5.2075420e-04,       
     ...
     & 2.8914483e-02,1.5822354e-04,-4.3874881e-03/    
      ...
      data (recfit(376,j),j=1,9) /-1.3471908e01,-5.2073761e-04,       
     ...
     & 2.8873259e-02,1.5804353e-04,-4.3828399e-03/    
      ...
      data (recfit(377,j),j=1,9) /-1.3473718e01,-5.1884778e-04,       
     ...
     & 2.8833093e-02,1.5785587e-04,-4.3779253e-03/    
      ...
      data (recfit(378,j),j=1,9) /-1.3475526e01,-5.1867502e-04,       
     ...
     & 2.8793992e-02,1.5766635e-04,-4.3729418e-03/    
      ...
      data (recfit(379,j),j=1,9) /-1.3477336e01,-5.1798020e-04,       
     ...
     & 2.8755860e-02,1.5746131e-04,-4.3675555e-03/    
      ...
      data (recfit(380,j),j=1,9) /-1.3479135e01,-5.1879266e-04,       
     ...
     & 2.8713973e-02,1.5727508e-04,-4.3627773e-03/    
      ...
      data (recfit(381,j),j=1,9) /-1.3480955e01,-5.0645816e-04,       
     ...
     & 2.8659787e-02,1.5719853e-04,-4.3612192e-03/    
      ...
      data (recfit(382,j),j=1,9) /-1.3482750e01,-5.0782535e-04,       
     ...
     & 2.8620133e-02,1.5701079e-04,-4.3563116e-03/    
      ...
      data (recfit(383,j),j=1,9) /-1.3484550e01,-5.0496479e-04,       
     ...
     & 2.8582441e-02,1.5681628e-04,-4.3511917e-03/    
      ...
      data (recfit(384,j),j=1,9) /-1.3486340e01,-5.0413748e-04,       
     ...
     & 2.8545359e-02,1.5663556e-04,-4.3463088e-03/    
      ...
      data (recfit(385,j),j=1,9) /-1.3488131e01,-5.0580583e-04,       
     ...
     & 2.8505942e-02,1.5644348e-04,-4.3413262e-03/    
      ...
      data (recfit(386,j),j=1,9) /-1.3489913e01,-5.0525734e-04,       
     ...
     & 2.8466556e-02,1.5625518e-04,-4.3363725e-03/    
      ...
      data (recfit(387,j),j=1,9) /-1.3491702e01,-5.0535059e-04,       
     ...
     & 2.8429180e-02,1.5608415e-04,-4.3319063e-03/    
      ...
      data (recfit(388,j),j=1,9) /-1.3493484e01,-5.0564634e-04,       
     ...
     & 2.8387567e-02,1.5589329e-04,-4.3270304e-03/    
      ...
      data (recfit(389,j),j=1,9) /-1.3495264e01,-5.0470192e-04,       
     ...
     & 2.8350485e-02,1.5570037e-04,-4.3219239e-03/    
      ...
      data (recfit(390,j),j=1,9) /-1.3497040e01,-5.0395192e-04,       
     ...
     & 2.8314052e-02,1.5551514e-04,-4.3169698e-03/    
      ...
      data (recfit(391,j),j=1,9) /-1.3498812e01,-5.0287205e-04,       
     ...
     & 2.8276579e-02,1.5532854e-04,-4.3120477e-03/    
      ...
      data (recfit(392,j),j=1,9) /-1.3500591e01,-5.0118362e-04,       
     ...
     & 2.8242085e-02,1.5514973e-04,-4.3072458e-03/    
      ...
      data (recfit(393,j),j=1,9) /-1.3502354e01,-4.9850869e-04,       
     ...
     & 2.8203795e-02,1.5496442e-04,-4.3023173e-03/    
      ...
      data (recfit(394,j),j=1,9) /-1.3504123e01,-4.9585995e-04,       
     ...
     & 2.7943892e-02,1.5372732e-04,-4.2696916e-03/    
      ...
      do j=1,nmax+1
         ...
         i=j-1
         rate = (recfit(i,1) + recfit(i,3)*x + recfit(i,5)*     
     &        x*x + recfit(i,7)*x**3 + recfit(i,9)*x**4)/                   
     &        (1.0 + recfit(i,2)*x + recfit(i,4)*x*x + recfit(i,6)*
     &        x**3 + recfit(i,8)*x**4)              
         reco(j) = 10.**rate/TeScaled                  
         trec = trec + reco(j)
c         write(6,9)j,(recfit(i,k),k=1,9),rate
 9       format(i5,1pe14.5,10e14.5)
      enddo

c add 2s and 2p and renumber 

      reco(2) = reco(2) + reco(3)
...
c      write(6,99)iz,te,reco(1),trec
 99   format('iz,te,reco(1),trec ',i5,1pe12.3,10e12.3)
